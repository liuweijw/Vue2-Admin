        ...
        <el-card class="box-card">
          <el-form ref="form" :model="form" label-width="80px">
            <el-form-item label="父节点ID">
              <el-input v-model="form.pid" :disabled="formMenu"></el-input>
            </el-form-item>
            <el-form-item label="节点ID">
              <el-input v-model="form.id" :disabled="formMenu"></el-input>
            </el-form-item>
...
export default {
  ...
  methods: {
    ...
    handleAddSubmit() {
      ...
      this.menuObj.menuId = null
      this.menuObj.pid = this.form.pid
    ...
    handleUpdSubmit() {
      ...
      this.menuObj.menuId = this.form.id
      this.menuObj.pid = this.form.pid
      this.menuObj.menuName = this.form.label
      this.menuObj.path = this.form.path
      this.menuObj.url = this.form.url
